...
@section('tittle','Pre Patrol Asset')
@push('header-name')
<h1>
    IT Assets
...
<ol class="breadcrumb">
    ...
    <li class="active">Pre Patrol Assets</li>
</ol>
@endpush
@section('content')
<div class="box">
               ...
               @foreach ($asset as $item)
                   <tr>
                       ...
                       {{-- <td>
                            ...
                            <a href="{{route('assets.show',$item->id)}}" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i> Detail</a>
                            <a href="{{route('assets.edit',$item->id)}}" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-edit"></i> Edit</a>
